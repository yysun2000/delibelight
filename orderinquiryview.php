...
<div id="sod_fin">
        ...
        <section id="sod_fin_pay">
            ...
            <div  class="odf_tbl">
                ...
                <tr>
                    ...
                    {
                    ?>
                        <a href="javascript:;" onclick="window.open('taxsave.php?od_id=<?php echo $od_id; ?>', 'taxsave', 'width=550,height=400,scrollbars=1,menus=0');">현금영수증을 발급하시려면 클릭하십시오.</a>
                    <?php } ?>
                    </td>
                </tr>
                <?php
    ...
    <div id="kcp_acc_test" class="odf_tbl">
        ...
        <tr>
            ...
            <td><input type="text" name="noti_url" value="settle_kcp_common.php"></td>
        </tr>
        </tbody>
        </table>
